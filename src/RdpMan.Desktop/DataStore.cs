...
public sealed class DataStore
{
    ...
    public void ExportBackup(AppData data, string fileName)
    {
        ...
        File.WriteAllText(fileName, JsonSerializer.Serialize(data, JsonOptions));
    }

    public AppData ImportBackup(string fileName)
    {
